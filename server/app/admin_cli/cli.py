...
def main():
    ...
    create.add_argument('tablename', type=str, help='Название таблицы')
    create.add_argument('-k', '--key', action='append', nargs=2, metavar=('KEY', 'VALUE'), help='Именованные аргументы для конструктора')

    delete = sub_parsers.add_parser('delete', help=Delete.__doc__)
    delete.add_argument('tablename', type=str, help='Название таблицы')
    delete.add_argument('id', type=int, help='ID записи, которую нужно удалить')
